...
class Start:
    ...
    def __init__(self):
        ...
        self.to_hiragana_quiz = Button(self.button_frame,
                                       ...
                                       fg=button_fg,
                                       bg="green",
                                       command=lambda: (self.input_questions()))
    ...
    def display_quiz(self, questions, mode):
        Display_Quiz(self, questions, mode)
        root.withdraw()

    def input_questions(self):
        error = "Please enter a whole number that is greater than 0"
        ...
        self.display_quiz(self.questions_todo.get(), self.mode_selected.get())
...
class Display_Quiz:
    ...
    def __init__(self, x, questions, mode):
        ...
        # opens and reads the csv file that holds the quiz resources
        ...
        self.submit_button = Button(self.question_frame,
                                    ...
                                    fg="white",
                                    width=12,
                                    command=lambda: (self.next_question(questions)))
        ...
        self.generate_question(questions)
    ...
    def generate_question(self, questions):
    ...
    def check_answer(self, questions):
        ...
        if self.submission.get().lower() == self.answer_word:
            ...
            self.feedback_message.config(fg="#048c7f")
        ...
        # otherwise the program tells the user it was wrong
            ...
            self.feedback_message.config(fg="#FF1111")
            self.feedback_message.config(text=f"incorrect the correct answer was '{self.answer_word}'")
