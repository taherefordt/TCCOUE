...
class Start:
    ...
    def __init__(self):
        ...
        instructions = "welcome to my japanese quiz " \
                       "if you haven't used this before  " \
                       "id recommend you click on the tutorial button " \
                       "otherwise, good luck, and thanks for participating"
...
class Display_Tutorial:
    ...
    def __init__(self, partner):
        ...
        # a list of image titles in the folder
        self.image_list = ["tutorial_page-1.png", "tutorial_page-2.png", "tutorial_page-3.png", "tutorial_page-4.png"]

        # the index of the image from the list that is currently displayed
        self.image_index = 0

        # the name of the currently displayed image
        self.selected_image = StringVar()

        # sets the name of the image to the first image
        self.selected_image.set(self.image_list[self.image_index])

        self.tutorial_box = Toplevel()

        # closes the tutorial button to prevent more windows spawning
        ...
        # frame for the dismiss and next buttons
        self.button_frame = Frame(self.tutorial_box)
        self.button_frame.grid(row=1)

        # when clicked this button shows the next slide
        ...
        # allows the user to quit the tutorial early
    ...
    def next_image(self, partner):
        ...
        if self.image_index < (len(self.image_list) - 1):
            ...
            if self.image_index < (len(self.image_list) - 1):
                ...
                self.next_button.config(text="dismiss")

            # grabs the correct image from the list of image files
            ...
            # if the slideshow is on the last image, the next button becomes a dismiss button
...
class Display_Table:
    ...
    def __init__(self, partner):
        ...
        # sets the [x] button so that it closes the vocab window
        ...
        # frame for the image and dismiss button
        self.image_frame = Frame(self.vocab_box, padx=5, pady=5)
        self.image_frame.grid()

        # brings the image from the files to the program
        image = tk.PhotoImage(file="jap_eng_vocab.png")

        # resizes the image to make it readable
        smaller_image = image.subsample(1, 1)
